...
//     //     getEMRData()
//     // },[])
//     console.log(emrDetails[0].fname);
//     return (
...
//                             <div class="grid-item">Name:  {emrDetails[0].fname} {emrDetails[0].lname}</div>
//                             <div class="grid-item">Date of birth:{emrDetails[0].dob}</div>
//                             <div class="grid-item">Gender: {emrDetails[0].gender}</div>
//                             <div class="grid-item">Blood group:{emrDetails[0].bloodGroup}</div>
//                             <div class="grid-item">Height:{emrDetails[0].height} cm</div>
//                             <div class="grid-item">Weight: {emrDetails[0].weight}kg</div>
//                             <div class="grid-item">BMI: {emrDetails[0].BMI}</div>
//                             <div class="grid-item">Id: {emrDetails[0].id}</div>
//                             <div class="grid-item">Age: {emrDetails[0].age}</div>
//                         </div>
//                     </div>
//                 </td>
...
//                             {
//                                 emrDetails && emrDetails[0].medicalhis.disease.map((disease)=>{
...
//                                 {
//                                 emrDetails && emrDetails[0].medicalhis.allergies?.map((disease)=>{
//                                     return   <tr class="">{disease}</tr>
//                                 })
//                             }
//                             </td>
...
//                             {
//                                 emrDetails && emrDetails[0].familyhis?.fatherside?.map((disease)=>{
//                                     return   <tr class="">{disease}</tr>
//                                 })
//                             }
//                             </tr>
...
//                                 {
//                                 emrDetails && emrDetails[0].familyhis?.motherside?.map((disease)=>{
//                                     return   <tr class="">{disease}</tr>
//                                 })
//                             }
//                             </tr>
...
//                             <tr class="">{emrDetails[0].status}</tr>
//                         </td>
//                         <td class="">
...
//                             <div>
//                                 <Button>
//                                     <Link style={{ color: 'white', textDecoration: 'none' }} to='/questionnaire'>
//                                         Next
//                                     </Link>
//                                 </Button>
//                             </div>
